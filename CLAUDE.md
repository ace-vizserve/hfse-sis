...
**Unmerged branches, deliberately left alone:** `feat/sis-admin-consolidation` (14 commits — parked by Mr Ace, do not resume unasked) and `worktree-fix-drill-sheet-data-loss` (7 commits, own remote). Neither was swept into main.
