...
**Current state (2026-05-04):** Sprint 32 in progress on `main` (uncommitted) — opt-in comparison refactor + plain-English UI copy audit + report-card transfer-aware data union + early-bird AY pipeline (migration 038, KD #77) + module-dashboard audit fixes. Sprint 31 (migration 037, KD #76) still uncommitted. Build clean.
