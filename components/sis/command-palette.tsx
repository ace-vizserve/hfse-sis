...
const NAV_ENTRIES: NavEntry[] = [
  ...
  { href: '/admissions/cohorts/medical', label: 'Medical alerts (admissions)', group: 'Cohorts', icon: StethoscopeIcon },
    ...
    <CommandDialog
      ...
      <CommandList>
        ...
        {canSearchStudents && query.length === 0 && (
          <div className="flex items-center gap-2 border-t border-hairline px-3 py-2 font-mono text-[10px] uppercase tracking-[0.12em] text-muted-foreground">
            <SearchIcon className="size-3" />
            Type at least 2 characters to search students across years
