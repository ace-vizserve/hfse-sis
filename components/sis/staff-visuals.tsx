...
// ─── Assignment chips ─────────────────────────────────────────────────────
//
// Moved to `components/sis/assignment-chips.tsx`. Their hints are a Radix
// tooltip, which needs `'use client'` — and this module is also rendered from
// server components (account/about-card, sections/adviser-cell,
// classroom/classroom-staff-panel), which would then have been pulled into
// the client bundle for an avatar. See that file's header for the full
// reasoning.
