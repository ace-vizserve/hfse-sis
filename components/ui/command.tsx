...
function CommandDialog({
  ...
  description = 'Search for navigation, actions, or students',
  children,
  className,
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        'ml-auto font-mono text-[10px] tracking-[0.12em] text-muted-foreground',
        className,
      )}
      {...props}
    />
