...
import { CalendarCheck, CalendarDays, FileUp, History, LogOut, UserCog, type LucideIcon } from 'lucide-react';
...
const PREFIX_MATCH_HREFS = new Set(['/attendance']);
...
export function AttendanceSidebar({ email, role }: { email: string; role: string }) {
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                {section.items.map((item) => {
                  const Icon = ICON_BY_HREF[item.href] ?? CalendarCheck;
                  return (
