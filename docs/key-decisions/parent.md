...
**Not built here, deliberately:** editing or withdrawing a filing; notifying the parent of the outcome; and travel's marks, which wait for the vacation count (Phase 4). Handoff brief for the portal's own repo: `docs/handoff/2026-08-27-parent-portal-declarations.md`.
