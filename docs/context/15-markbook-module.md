...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `lib/sync/students.ts`                                                                                                                                                                                                                | ✅ **Records module** (shipped — daily Vercel Cron `POST /api/sis/students/auto-sync`, no UI trigger; gaps needing a human decision surface on the Records unsynced-students queue at `/records/unsynced`, KD #90/#154) | The sync is about student records, not academics. Markbook consumes its output (`students`, `section_students`) but doesn't own the domain.                                                                                                   |
