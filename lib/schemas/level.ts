...
// The grade-level admin CRUD schemas that used to live here
// (LevelAdminCreateSchema/LevelAdminUpdateSchema/LevelOfferingSchema, back
// POST/PATCH/DELETE `/api/sis/admin/levels[...]` + the per-AY
// `ay_level_offerings` toggle) were removed by migration 086 alongside the
// whole Grade Levels admin page — see lib/sis/levels.ts's header note.
// LevelCreateSchema/LevelRemapSchema above are UNCHANGED — a distinct,
// already-shipped schema for the admissions-level-review reconciliation
// flow, unrelated to the admin CRUD feature that was removed.
