...
// `getOutreachForRoster` filters past-due promises out (DocumentCard's
// "Promised by [date]" badge only wants live commitments) — the promised
// cohort needs them so the chase queue can flag missed dates.
