 ...
 *
 * The bound matters and is not arbitrary. Firing hundreds of RPCs at once
 * exhausts the client's connection pool and draws rate-limit warnings — so
 * nothing here is ever unbounded. A class-sized batch can afford eight at a
 * time.
 */
