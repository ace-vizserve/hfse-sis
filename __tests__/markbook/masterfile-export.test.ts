...
function makePayload(): MasterfilePayload {
  const active: MasterfileStudentRow = {
    ...
    overallAward: 'Silver',
    attendanceByTerm: [
      { termId: 't1', schoolDays: 45, present: 44, late: 1 },
      { termId: 't2', schoolDays: 45, present: 45, late: 0 },
      { termId: 't3', schoolDays: 45, present: 43, late: 2 },
  ...
  const withdrawn: MasterfileStudentRow = {
    ...
    attendanceByTerm: [
      { termId: 't1', schoolDays: 0, present: 0, late: 0 },
      { termId: 't2', schoolDays: 0, present: 0, late: 0 },
      { termId: 't3', schoolDays: 0, present: 0, late: 0 },
      { termId: 't4', schoolDays: 0, present: 0, late: 0 },
    ],
