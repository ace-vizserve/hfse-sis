...
// Generates ay2026-t1-attendance-{preview,apply}.sql from HFSE's real T1
...
async function main() {
  ...
  writeFileSync(
    'scripts/backfill/ay2026-t1-attendance-apply.sql',
    result.apply
  );

  console.log('Stats:', JSON.stringify(result.stats, null, 2));
  console.log('Wrote scripts/backfill/ay2026-t1-attendance-preview.sql');
  console.log('Wrote scripts/backfill/ay2026-t1-attendance-apply.sql');
}
