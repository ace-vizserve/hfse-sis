    ...
    <PageShell>
      ...
      <header className="space-y-3">
        ...
        <p className="max-w-2xl text-[15px] leading-relaxed text-muted-foreground">
          Report-card signature names, PEI registration number, and the default publication window.
          One singleton row; changes reflect on every new report-card render.
        </p>
      </header>
