...
/**
 * Mirrors `app/(admissions)/admissions/cohorts/stp/page.tsx` (and the chrome
 * it renders through, `components/sis/cohorts/cohort-page-shell.tsx`) —
 ...
 * `CohortTable` (`kind="stp"`, `scope="funnel"`) — a `DataTable` with search
 * + FOUR facets, a three-tab status strip, and eight visible columns
 * (student, level, STP type, ICA status, residence, STP complete, app status,
 * row actions).
 */
    ...
    <PageShell>
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* No `pagination`: the bar renders only when the filtered set is
            non-empty, and this cohort is a narrow slice of the funnel that can
