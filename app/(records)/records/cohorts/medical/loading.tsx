...
/**
 * Mirrors `app/(records)/records/cohorts/medical/page.tsx` (and the chrome it
 ...
 * conditions, dietary, paracetamol consent, app status, row actions).
 */
    ...
    <PageShell>
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* No `pagination`: the bar renders only when the filtered set is
            non-empty, and a cohort of students carrying a medical flag can
